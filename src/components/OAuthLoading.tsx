...
export function OAuthLoading() {
  return (
    <div className="ui-fixed ui-inset-0 ui-z-[1000] ui-flex ui-items-center ui-justify-center ui-gap-6 ui-rounded-none sm:ui-rounded-[48px] ui-shadow-xl ui-p-10 ui-w-full sm:ui-max-w-lg md:ui-min-w-[560px] ui-bg-white">
