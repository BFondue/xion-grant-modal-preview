...
const EllipsisButton = React.forwardRef<HTMLButtonElement, EllipsisButtonProps>(
  ({ onClick, className, ...props }, ref) => {
    const buttonStyles = cn(
      "ui-w-7 ui-h-7 ui-rounded-full ui-border ui-border-white/60 ui-bg-transparent hover:ui-bg-white/10 !ui-p-0",
      className,
    );
    ...
    return (
      ...
      >
        <div className="ui-flex ui-flex-col ui-items-center ui-justify-center ui-gap-0.5 ui-h-full">
          <div className="ui-w-1 ui-h-1 ui-bg-white/60 ui-rounded-full" />
          <div className="ui-w-1 ui-h-1 ui-bg-white/60 ui-rounded-full" />
          <div className="ui-w-1 ui-h-1 ui-bg-white/60 ui-rounded-full" />
        </div>
      </BaseButton>
