...
export function IframeModalBase({
  ...
  return (
    <>
      {showLogo && (
        <DialogHeader>
          <div className="ui-flex ui-flex-col ui-items-center ui-gap-1.5 ui-w-full">
            <div className="ui-flex ui-items-center ui-space-x-2.5">
              <img
                ...
                style={{ filter: "var(--modal-logo-filter, brightness(0))" }}
              />
              <div
                className="ui-flex ui-justify-between ui-items-center ui-h-[18px] ui-bg-testnet-bg ui-px-1 ui-py-0 ui-mb-1.5 ui-text-testnet ui-rounded-[4px] ui-text-[10px] ui-tracking-widest"
                style={{
                  backgroundColor:
                    "var(--modal-badge-bg, rgb(255, 74, 74, 0.1))",
            ...
            {description && (
              <DialogDescription
                style={{ color: "var(--modal-secondary-text-color, inherit)" }}
              >
                {description}
              </DialogDescription>
            )}
        ...
        <DialogHeader>
          {typeof title === "string" ? (
            <h2
              ...
              style={{ color: "var(--modal-text-color, inherit)" }}
            >
              {title}
            </h2>
          ) : (
      ...
      <div
        className="ui-flex-1"
        style={{ fontFamily: "var(--modal-font-family, inherit)" }}
      >
        {children}
      </div>
      ...
      {showDisclaimer && (
        <div className="ui-text-caption ui-font-normal ui-leading-5 ui-text-center ui-max-w-[340px] ui-mx-auto ui-mt-4">
          <span
            className="ui-text-secondary-text"
            style={{ color: "var(--modal-secondary-text-color, inherit)" }}
          >
          ...
          <a
            ...
            style={{ color: "var(--modal-primary-color, #111827)" }}
          >
            Disclaimer
          </a>
          <span
